...
TEST(ExecutorReverseTest, should_return_facing_is_S_given_command_is_BL_and_facing_is_E)
{
    auto executor = Executor::NewExecutor({0,0,'E'});
    executor -> Execute("BL");
...
TEST(ExecutorReverseTest, should_return_facing_is_N_given_command_is_BR_and_facing_is_E)
{
    auto executor = Executor::NewExecutor({0,0,'E'});
    executor -> Execute("BR");
...
TEST(ExecutorReverseFastTest, should_return_x_minus_1_and_S_given_status_is_fast_and_reverse_command_is_L_and_facing_is_E)
{
    auto executor = Executor::NewExecutor({0,0,'E'});
...
TEST(ExecutorReverseFastTest, should_return_x_minus_1_and_N_given_status_is_fast_and_reverse_command_is_R_and_facing_is_E)
{
    auto executor = Executor::NewExecutor({0,0,'E'});
